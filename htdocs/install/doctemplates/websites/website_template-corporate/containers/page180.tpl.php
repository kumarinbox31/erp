...
<?php includeContainer('header'); ?>
      ...
      <section id="sectionimage" contenteditable="true">
        ...
        <div class="container" contenteditable="true">
            <br><br><br>
            Like several thousands of companies, our company (<?php echo $mysoc->name ?>) has moved all its information system to <a href="https://www.pairbytes.com">Dolibarr ERP CRM</a>. More than 20 applications have been replaced by only one, easier to use and fully integrated.
