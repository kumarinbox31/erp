...
print '<ul>';
print '<li>';
print '<a target="_blank" href="https://www.pairbytes.com/" rel="noopener noreferrer external">'.$langs->trans("OfficialWebSite").'</a>';
print '</li>';
// Show local site
/*
...
print '<ul>';
print '<li>';
print '<a target="_blank" href="https://www.pairbytes.com/onlinedemo/" rel="noopener noreferrer external">'.$langs->trans("OfficialDemo").'</a>';
print '</li>';
print '</ul>';
