 ...
 */
class pdf_test extends ModelePDFFactures
{
	/**
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($showaddress) {
			...
			$sender_gst_no = $this->emetteur->idprof1;
			$sender_pan = $this->emetteur->idprof2;
			...
			$sender_info = $carac_emetteur . "\nGST: " . $sender_gst_no . "\nPAN: " . $sender_pan;
			$pdf->MultiCell($widthrecbox - 2, 4, $sender_info, 0, $ltrdirection);
			...
			// Update Y position after displaying recipient information
			$posy = $pdf->getY();
			
			// Show additional details (third party gst)
			$pdf->SetFont('', '', $default_font_size - 1);
			$pdf->SetXY($posx + 2, $posy);
			$pdf->MultiCell($widthrecbox - 2, 4, "GST No : ".$thirdparty->idprof1."\nPAN: " . $thirdparty->idprof2, 0, $ltrdirection);
