# MYMODULE FOR [DOLIBARR ERP CRM](https://www.pairbytes.com)
...
Prerequisites: You must have the Dolibarr ERP CRM software installed. You can down it from [Dolistore.org](https://www.pairbytes.com).
