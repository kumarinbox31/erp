...
/**
 * \file    attendance/core/boxes/attendancewidget1.php
 * \ingroup attendance
 * \brief   Widget provided by Attendance
 *
 ...
 */
class attendancewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "attendancebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "attendance@attendance";
	 ...
	 */
	public $depends = array('attendance');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "attendance@attendance"));
		...
		// $this->hidden = !$user->hasRight('attendance', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/attendance/class/attendance.class.php");

		// Populate the head at runtime
		$text = $langs->trans("AttendanceBoxDescription", $max);
		$this->info_box_head = array(
			// Title text
			'text' => $text,
			// Add a link
			'sublink' => 'https://pairbytes.com/',
			// Sublink icon placed after the text
			'subpicto' => 'object_attendance@attendance',
